...
ActiveRecord::Schema[7.1].define(version: 2024_10_17_080216) do
  ...
  add_foreign_key "admins_personal_informations", "admins"
  add_foreign_key "bookings", "users"
  add_foreign_key "users_personal_informations", "users"
end
